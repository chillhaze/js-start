...
// console.log(getNamesSortedByFriendCount(usersSort));

// Задача 43 -----------------------------------------
// Дополни функцию getSortedFriends(users) так, чтобы она возвращала массив уникальных имён друзей (свойство friends) отсортированный по алфавиту .
// const getSortedFriends = (usersSort) => {
//   return [...usersSort]
...
// console.log(getSortedFriends(usersSort));

// Задача 44 -----------------------------------------
// Дополни функцию getTotalBalanceByGender(users, gender) так, чтобы она возвращала общий баланс пользователей (свойство balance), пол которых (свойство gender) совпадает со значением параметра gender.
// const gender = "female";
// const getTotalBalanceByGender = (usersSort, gender) => {
//   return [...usersSort]
//     .filter((user) => {
...
// console.log(getTotalBalanceByGender(usersSort, gender));
